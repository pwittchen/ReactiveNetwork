...
public class LollipopNetworkObservingStrategy
  ...
  public Observable<Connectivity> observeNetworkConnectivity(final Context context) {
    ...
    return Observable.create(
        (ObservableOnSubscribe<Connectivity>) subscriber -> {
    ...
    ).doOnDispose(() -> tryToUnregisterCallback(manager))
        .startWith(Observable.just(Connectivity.create(context)))
  ...
  @Override
  public void onError(final String message, final Throwable exception) {
