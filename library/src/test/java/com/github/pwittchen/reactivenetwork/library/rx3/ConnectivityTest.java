...
@SuppressWarnings("NullAway") public class ConnectivityTest {
  ...
  @Test public void stateShouldBeEqualToGivenValue() throws Throwable {
    // given
  ...
  @Test public void stateShouldBeEqualToOneOfGivenMultipleValues() throws Throwable {
    // given
  ...
  @Test public void stateShouldNotBeEqualToGivenValue() throws Throwable {
    // given
  ...
  @Test public void typeShouldBeEqualToGivenValue() throws Throwable {
    // given
    final Connectivity connectivity = Connectivity.state(NetworkInfo.State.CONNECTED)
        .type(ConnectivityManager.TYPE_WIFI)
        .typeName(TYPE_NAME_WIFI)
  ...
  @Test public void typeShouldBeEqualToOneOfGivenMultipleValues() throws Throwable {
    // given
    final Connectivity connectivity = Connectivity.state(NetworkInfo.State.CONNECTING)
  ...
  @Test public void typeShouldNotBeEqualToGivenValue() throws Throwable {
    // given
    final Connectivity connectivity = Connectivity.state(NetworkInfo.State.CONNECTED)
        .type(ConnectivityManager.TYPE_WIFI)
        .typeName(TYPE_NAME_WIFI)
