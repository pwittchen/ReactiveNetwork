...
**This is draft of the documentation for version 0.5.0, so documentation may be outdated until this version will be available on Maven Central Repository!**
